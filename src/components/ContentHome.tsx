...
const ContentHome: React.FC = () => {
  ...
  return (
    <div id="home" className="min-h-[83vh] scroll-mt-[83vh] flex items-end w-[100%] md:w-[90%]">
      <div className='flex-1 pb-0 p-4 pb-[3rem] bg-[#0a1628] rounded-xl'>
        ...
        <div className='block sm:flex font-mono gap-6 md:gap-12'>
          ...
          <a href={cvFile} download="CV_Kamil_Przybyla.pdf" className='mt-[34px] flex w-[200px] md:w-[250px] lg:w-[200px] xl:w-[250px] text-white bg-opacity-50 bg-gray-800 border border-white h-[50px] rounded-full flex cursor-pointer items-center justify-center transition-all duration-300 hover:bg-gray-600'>
